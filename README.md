...
![完成 DeepSeek API 充值](./完成deepseek%20api充值.png)
...
![确认开启开发者模式](./确认开启开发者模式.png)

![选中开启开发者模式](./选中开启开发者模式.png)
...
![选中 Gateway](./选中gateway.png)

![设置 DeepSeek Connection](./设置deepseek%20connection.png)
