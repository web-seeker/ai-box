...
<img src="./claude-code-deepseek/完成deepseek%20api充值.png" alt="完成 DeepSeek API 充值" width="500">
...
<img src="./claude-code-deepseek/选中开启开发者模式.png" alt="确认开启开发者模式" width="500">

<img src="./claude-code-deepseek/确认开启开发者模式.png" alt="选中开启开发者模式" width="500">

打开 Claude Code 桌面端 → 进入 Settings → 开启 **Developer Mode（开发者模式）** → 重启客户端。

### Step 3：选择第三方接入

<img src="./claude-code-deepseek/选中第三方接入.png" alt="选中第三方接入" width="500">

在开发者设置中，选择 **Configure Third-Party Inference...**。

### Step 4：配置 Gateway 连接

<img src="./claude-code-deepseek/选中gateway.png" alt="选中 Gateway" width="500">

<img src="./claude-code-deepseek/设置deepseek%20connection.png" alt="设置 DeepSeek Connection" width="500">
...
<img src="./claude-code-deepseek/最终呈现.png" alt="最终呈现" width="500">
...
<img src="./claude-code-deepseek/快速笔记.png" alt="快速笔记" width="500">
